...
En esta sección se detallan los diferentes casos de uso para cada uno de los requisitos funcionales definidos en las tablas \ref{Requisitos} y \ref{Requisitos2}.
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|l|}
		...
		Flujo           & \begin{tabular}[c]{@{}l@{}}1. El usuario solicita modificar un fondo\\ 2. La vista proporciona una ventana en la que modificar los datos\\ 3. El usuario modifica los datos del fondo\\ 4. El usuario confirma los datos modificados\\ 5. El presentador formatea los datos y llama al modelo\\ 6. El modelo recibe los datos y actualiza el fondo en la\\ base de datos\end{tabular} \\ \hline
		Flujo alternativo & 4.1 El usuario cancela la modificación                                                                                                                                                                                                                                                                                                    \\ \hline
		Postcondiciones & El fondo modificado en la base de datos                                                                                                                                                                                                                                                                                                                                                     \\ \hline
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|l|}
		...
		Flujo           & \begin{tabular}[c]{@{}l@{}}1. El usuario solicita modificar una cartera\\ 2. La vista proporciona una ventana en la que modificar los datos\\ 3. El usuario modifica los datos de la cartera\\ 4. El usuario confirma los datos modificados\\ 5. El presentador formatea los datos y llama al modelo\\ 6. El modelo recibe los datos y actualiza la cartera en la base\\ de datos\end{tabular} \\ \hline
		Flujo alternativo & 4.1 El usuario cancela la modificación                                                                                                                                                                                                                                                                 \\ \hline
		Postcondiciones & La cartera modificada en la base de datos                                                                                                                                                                                                                                                                                                                                                      \\ \hline
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|l|}
		...
		Flujo           & \begin{tabular}[c]{@{}l@{}}1. El usuario solicita modificar un valor liquidativo\\ 2. La vista proporciona una ventana en la que modificar los datos\\ 3. El usuario modifica los datos del valor liquidativo\\ 4. El usuario confirma los datos modificados\\ 5. El presentador formatea los datos y llama al modelo\\ 6. El modelo recibe los datos y actualiza el valor liquidativo del\\ fondo en la base de datos\end{tabular} \\ \hline
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|l|}
		...
		Actores           & Usuario, modelo, vista, presentador                                                                                                                                                                                                                                                                                                                              \\ \hline
		Precondiciones    & La cartera existe en la base de datos                                                                                                                                                                                                                                                                                                                            \\ \hline
		Flujo             & \begin{tabular}[c]{@{}l@{}}1. El usuario solicita eliminar una cartera\\ 2. La vista proporciona una ventana de confimación\\ 3. El usuario confirma el borrado\\ 4. El presentador llama al modelo\\ 5. El modelo recibe los datos de la cartera y la elimina de la \\ base de datos junto con todas las operaciones realizadas sobre\\ sus fondos\end{tabular} \\ \hline
		Flujo alternativo & 3.1 El usuario cancela el borrado                                                                                                                                                                                                                                                                                                                                \\ \hline
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|l|}
		...
		Flujo             & \begin{tabular}[c]{@{}l@{}}1. El usuario solicita eliminar un valor liquidativo\\ 2. La vista proporciona una ventana de confimación\\ 3. El usuario confirma el borrado\\ 4. El presentador llama al modelo\\ 5. El modelo recibe los datos del valor liquidativo y lo elimina\\ de la base de datos.\end{tabular} \\ \hline
		Flujo alternativo & 3.1 El usuario cancela el borrado                                                                                                                                                                                                                                                                                   \\ \hline
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|l|}
		...
		Flujo             & \begin{tabular}[c]{@{}l@{}}1. El usuario solicita importar los valores liquidativos\\ 2. La vista proporciona una ventana donde seleccionar el\\ fichero desde el que se importarán\\ 3. El usuario selecciona el fichero\\ 4. El presentador llama al modelo pasandole el fichero\\ 5. El modelo recibe el fichero e importa los valores liquidativos\\ al fondo seleccionado\end{tabular} \\ \hline
		Flujo alternativo & 3.1 El usuario cancela la selección del fichero                                                                                                                                                                                                                                                                                                                                             \\ \hline
		Postcondiciones   & \begin{tabular}[c]{@{}l@{}}Los valores liquidativos contenidos en el fichero añadidos a la \\ base de datos asignados al fondo seleccionado\end{tabular}                                                                                                                                                                                                                                    \\ \hline
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|l|}
		...
		Flujo             & \begin{tabular}[c]{@{}l@{}}1. El usuario solicita importar un fondo\\ 2. La vista proporciona una ventana donde seleccionar el\\ fichero desde el que se importará\\ 3. El usuario selecciona el fichero\\ 4. El presentador llama al modelo pasandole el fichero\\ 5. El modelo recibe el fichero y añade el fondo y su conjunto\\ de valores liquidativos a la base de datos\end{tabular} \\ \hline
		Flujo alternativo & 3.1 El usuario cancela la selección del fichero                                                                                                                                                                                                                                                                                                                                             \\ \hline
		Postcondiciones   & \begin{tabular}[c]{@{}l@{}}El fondo y su conjunto de valores liquidativos añadidos\\ a la base de datos\end{tabular}                                                                                                                                                                                                                                                                        \\ \hline
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|l|}
		...
		Flujo             & \begin{tabular}[c]{@{}l@{}}1. El usuario solicita añadir un fondo a una cartera\\ 2. La vista proporciona una ventana donde seleccionar la\\ cartera y el fondo\\ 3. El usuario selecciona la cartera y el fondo\\ 4. El usuario confirma la operación\\ 5. El presentador llama al modelo pasandole los datos\\ 6. El modelo recibe los datos y añade el fondo a la cartera\\ en la base de datos\end{tabular} \\ \hline
		Flujo alternativo & 4.1 El usuario cancela la operación                                                                                                                                                                                                                                                                                                                                                                             \\ \hline
		Postcondiciones   & El fondo añadido a la cartera en la base de datos                                                                                                                                                                                                                                                                                                                                                               \\ \hline
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|l|}
		...
		Actores           & Usuario, modelo, vista, presentador                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
		Precondiciones    & El fondo y la cartera existen en la base de datos                                                                                                                                                                                                                                                                                                                                                                      \\ \hline
		Flujo             & \begin{tabular}[c]{@{}l@{}}1. El usuario solicita eliminar un fondo de una cartera\\ 2. La vista proporciona una ventana donde seleccionar la\\ cartera y el fondo\\ 3. El usuario selecciona la cartera y el fondo\\ 4. El usuario confirma la operación\\ 5. El presentador llama al modelo pasandole los datos\\ 6. El modelo recibe los datos y elimina el fondo \\ de la cartera en la base de datos\end{tabular} \\ \hline
		Flujo alternativo & 4.1 El usuario cancela la operación                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
		Postcondiciones   & El fondo no añadido a la cartera en la base de datos                                                                                                                                                                                                                                                                                                                                                                   \\ \hline
...
\begin{table}[]
	...
	\begin{tabular}{|l|l|}
		...
		Actores           & Usuario, modelo, vista, presentador                                                                                                                                                                                                                                                                                                                                                                                                                                             \\ \hline
		Precondiciones    & El fondo y la cartera existen en la base de datos                                                                                                                                                                                                                                                                                                                                                                                                                               \\ \hline
		Flujo             & \begin{tabular}[c]{@{}l@{}}1. El usuario solicita añadir una operación sobre un fondo\\ de una cartera\\ 2. La vista proporciona una ventana donde seleccionar la\\ cartera y el fondo\\ 3. El usuario selecciona la cartera y el fondo\\ 4. El usuario introduce el valor de la operación\\ 5. El usuario confirma la operación\\ 6. El presentador llama al modelo pasandole los datos\\ 7. El modelo recibe los datos y añade la operación a la\\ base de datos\end{tabular} \\ \hline
		Flujo alternativo & 5.1 El usuario cancela la operación                                                                                                                                                                                                                                                                                                                                                                                                                                             \\ \hline
		Postcondiciones   & \begin{tabular}[c]{@{}l@{}}El la operación sobre el fondo de la cartera añadida a la\\ base de datos\end{tabular}                                                                                                                                                                                                                                                                                                                                                               \\ \hline
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|l|}
		...
		Flujo             & \begin{tabular}[c]{@{}l@{}}1. El usuario solicita modificar una operación existente\\ sobre un fondo de una cartera en un día determinado\\ 2. La vista proporciona una ventana donde visualizar los datos\\ de la operación\\ 3. El usuario modifica la operación\\ 4. El usuario confirma los datos modificados\\ 5. El presentador llama al modelo pasandole los datos\\ 6. El modelo recibe los datos y actualiza la operación en la\\ base de datos\end{tabular} \\ \hline
		Flujo alternativo & 3.1 El usuario cancela la modificación                                                                                                                                                                                                                                                                                                                                                                                                                                \\ \hline
		Postcondiciones   & La operación modificada en la base de datos                                                                                                                                                                                                                                                                                                                                                                                                                           \\ \hline
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|l|}
		...
		Actores           & Usuario, modelo, vista, presentador                                                                                                                                                                                                                                                                                                                                  \\ \hline
		Precondiciones    & El fondo, la cartera y la operacíon existen en la base de datos                                                                                                                                                                                                                                                                                                      \\ \hline
		Flujo             & \begin{tabular}[c]{@{}l@{}}1. El usuario solicita borrar una operación existente\\ sobre un fondo de una cartera en un día determinado\\ 2. La vista proporciona una ventana de confirmación\\ 3. El usuario confirma el borrado\\ 4. El presentador llama al modelo\\ 5. El modelo recibe los datos de la operación y la elimina\\ de la base de datos\end{tabular} \\ \hline
		Flujo alternativo & 3.1 El usuario cancela el borrado                                                                                                                                                                                                                                                                                                                                    \\ \hline
		Postcondiciones   & La operación eliminada de la base de datos                                                                                                                                                                                                                                                                                                                           \\ \hline
...
\begin{table}[]
	...
	\begin{tabular}{|l|l|}
		...
		Actores           & Usuario, modelo, vista, presentador                                                                                                                                                                                                                                                     \\ \hline
		Precondiciones    & El fondo existe en la base de datos                                                                                                                                                                                                                                                     \\ \hline
		Flujo             & \begin{tabular}[c]{@{}l@{}}1. El usuario solicita ver los valores liquidativos de un\\ fondo\\ 2. La vista proporciona una ventana donde seleccionar\\ el fondo\\ 3. El usuario selecciona el fondo\\ 4. La vista muestra la lista de los valores liquidativos\\ del fondo\end{tabular} \\ \hline
		Flujo alternativo &                                                                                                                                                                                                                                                                                         \\ \hline
		Postcondiciones   & \begin{tabular}[c]{@{}l@{}}El conjunto de valores liquidativos del fondo mostrados\\ al usuario\end{tabular}                                                                                                                                                                            \\ \hline
		Excepciones       & Ninguna                                                                                                                                                                                                                                                                                 \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[]
	...
	\begin{tabular}{|l|l|}
		...
		Flujo             & \begin{tabular}[c]{@{}l@{}}1. El usuario solicita ver las operaciones de una cartera\\ 2. La vista proporciona una ventana donde seleccionar\\ el fondo y la cartera\\ 3. El usuario selecciona el fondo y la cartera\\ 4. El presentador pasa los datos al modelo\\ 5. El modelo obtiene todas las operaciones de la cartera\\ sobre el fondo\\ 6. La vista muestra la lista de las operaciones\end{tabular} \\ \hline
		Flujo alternativo & 3.1 El usuario cancela la operación                                                                                                                                                                                                                                                                                                                                                                           \\ \hline
		Postcondiciones   & \begin{tabular}[c]{@{}l@{}}El conjunto de operaciones de la cartera sobre el fondo\\ mostradas al usuario\end{tabular}                                                                                                                                                                                                                                                                                        \\ \hline
		Excepciones       & \begin{tabular}[c]{@{}l@{}}El fondo no se encuentra añadido a la cartera en la base\\ de datos\end{tabular}                                                                                                                                                                                                                                                                                                   \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|l|}
		...
		Flujo             & \begin{tabular}[c]{@{}l@{}}1. El usuario solicita ver las descripcción de un fondo\\ 2. La vista proporciona una ventana donde seleccionar\\ el fondo\\ 3. El usuario selecciona el fondo\\ 4. El presentador pasa los datos al modelo\\ 5. El modelo obtiene la descripción del fondo\\ 6. El presentador calcula sus métricas de rendimiento\\ 7. La vista muestra la descripción del fondo y sus\\ métricas de rendimiento\end{tabular} \\ \hline
		Flujo alternativo & 3.1 El usuario cancela la operación                                                                                                                                                                                                                                                                                                                                                                                                        \\ \hline
		Postcondiciones   & \begin{tabular}[c]{@{}l@{}}La descripción del fondo y sus métricas de rendimiento\\ mostradas al usuario\end{tabular}                                                                                                                                                                                                                                                                                                                      \\ \hline
		Excepciones       & Ninguna                                                                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[]
	...
	\begin{tabular}{|l|l|}
		...
		Flujo             & \begin{tabular}[c]{@{}l@{}}1. El usuario solicita ver una determinada gráfica de un\\ fondo o cartera\\ 2. La vista proporciona una ventana donde seleccionar\\ el fondo o la cartera\\ 3. El usuario selecciona el fondo\\ 4. El presentador pasa los datos al modelo\\ 5. El modelo obtiene los datos del fondo o la cartera y\\ se los devuelve al presentador\\ 6. El presentador calcula la gráfica\\ 7. La vista muestra la gráfica\end{tabular} \\ \hline
		Flujo alternativo & 3.1 El usuario cancela la operación                                                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
		Postcondiciones   & La gráfica solicitada mostrada al usuario                                                                                                                                                                                                                                                                                                                                                                                                              \\ \hline
		Excepciones       & Ninguna                                                                                                                                                                                                                                                                                                                                                                                                                                                \\ \hline
	\end{tabular}
\end{table}
